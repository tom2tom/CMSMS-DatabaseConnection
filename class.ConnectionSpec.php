...
class ConnectionSpec
{
     ...
     */
    private $_data = [
    'type' => 'mysqli', 'host' => null, 'username' => null, 'password' => null,
    'dbname' => null, 'prefix' => null, 'port' => null, 'persistent' => false,
    'debug' => false, 'auto_exec' => null, ];
     ...
     *
     * @return bool Whether there is enough information to connect to the database
     */
    public function valid()
    {
        return $this->type && $this->host && $this->username && $this->password && $this->dbname;
    }
}
